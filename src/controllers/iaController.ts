...
export class IaController {
  async MovieRecomendationService(req: Request, res: Response) {
    ...
    const command = `python ../filmo-ia/recomendation_ai/src/main.py ${formatedName}`;
    exec(command, (error, stdout /*stderr*/) => {
      ...
      const options = {
        ...
        headers: {
          ...
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkMzc4MzFiYWQ5YTY3OGM2NDZkZDlmYWFkZDIzMDI5MiIsInN1YiI6IjY2MDlmMDI3NjJmY2QzMDE3Y2UwNGZhNCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.77D_K8boI8f1NbgfPaMctB-n36DExhnndycRyMEWBVk",
        },
      };
